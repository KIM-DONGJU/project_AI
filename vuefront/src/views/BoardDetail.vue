        ...
        <div id="board_detail_update_bg">
			...
			<form>
				<table class="board_detail_info_table">
					...
					<tr>
						<td><p id="board_detail_subject">수정할 게시글 제목</p><br><p id="board_detail_writer_info">작성자명 / 작성시간</p></td>
					</tr>
				</table>
				...
				<table class="board_detail_content_table">
					...
					<tr>
						<td><p id="board_detail_contents">수정할 게시글 내용</p></td>
					</tr>
				</table>
			</form>
		
    	</div>
		<button v-on:click="contents_modified" id="board_detail_modified">수정</button>
		<button v-on:click="contents_deleted" id="board_detail_deleted">삭제</button>
