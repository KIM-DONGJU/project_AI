<template>
    <div class="board_write">
        ...
        <div id="write_area">
            <input type="text" id="board_write_subject" placeholder="게시글 제목을 입력하세요."/>
            <textarea id="board_write_contents" rows="10" placeholder="내용을 입력하세요."/>
            <button v-on:click="contents_write" id="board_write">등록</button>
        </div>
